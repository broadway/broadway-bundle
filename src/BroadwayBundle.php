...
class BroadwayBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new RegisterEventStoreCompilerPass(), 0, 0);
        $container->addCompilerPass(new RegisterReadModelRepositoryFactoryCompilerPass(), 0, 0);
        $container->addCompilerPass(new RegisterSagaStateRepositoryCompilerPass(), 0, 0);
        ...
        $container->addCompilerPass(
            new RegisterSerializersCompilerPass(), 0, 0
        );
    }
}
